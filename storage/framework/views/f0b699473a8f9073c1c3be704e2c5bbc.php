<?php
 ...
 <footer class="dash-footer">
     <div class="footer-wrapper">
         <div class="py-1">
             <span class="text-muted">  <?php if(isset($setting['footer_text']) && (strpos($setting['footer_text'], "©") === false && strpos($setting['footer_text'], "&copy;") === false)): ?>
                    &copy;
                <?php endif; ?>

                <?php echo e(date('Y')); ?>

                <?php echo e(isset($setting['footer_text']) ? $setting['footer_text'] : config('app.name', 'E-CommerceGo')); ?>  </span>
         </div>
     </div>
 </footer>
...
<?php if(module_is_active('SidebarCustomization')): ?>
    <script src="<?php echo e(asset('assets/js/side-dash.js')); ?>"></script>
<?php else: ?>
...
<script src="<?php echo e(asset('public/assets/js/plugins/dropzone.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/plugins/select2.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/moment/min/moment.min.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('public/js/html2pdf.bundle.min.js')); ?>"></script>
        ...
        custdarklayout.addEventListener("click", function() {
            ...
            if (custdarklayout.checked) {
                document.querySelector(".m-header > .b-brand > .logo-lg").setAttribute("src",
                    ...
                    if (rtl.checked) {
                        document.querySelector("#main-style-link").setAttribute("href", "<?php echo e(asset('assets/css/rtl-style-dark.css')); ?>");
                        document.querySelector("#main-style-custom-link").setAttribute("href", "<?php echo e(asset('css/rtl-custom.css')); ?>");
                        ...
                        document.querySelector("#main-style-custom-link").setAttribute("href", "<?php echo e(asset('css/custom.css')); ?>");
                ...
                document.querySelector(".m-header > .b-brand > .logo-lg").setAttribute("src",
                    ...
                    if (rtl.checked) {
                        document.querySelector("#main-style-link").setAttribute("href", "<?php echo e(asset('assets/css/style-rtl.css')); ?>");
                        document.querySelector("#main-style-custom-link").setAttribute("href", "<?php echo e(asset('css/rtl-custom.css')); ?>");
                        document.querySelector('#html-dir-tag').setAttribute('dir', 'rtl');
                    } else if (!rtl.checked) {
                        document.querySelector("#main-style-link").setAttribute("href", "<?php echo e(asset('assets/css/style.css')); ?>");
...
<?php /**PATH C:\laragon\www\anaonline\resources\views/partision/footerlink.blade.php ENDPATH**/ ?>