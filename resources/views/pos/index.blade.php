                                        ...
                                        @if (getCurrentStore() == $product->store_id)
                                            <tr data-product-id="{{ $id }}"
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                            class="show_confirm btn btn-sm btn-danger" data-confirm="{{ __('Are You Sure?') }}"
                                                            data-text="{{ __('This action can not be undone. Do you want to continue?') }}" data-text-yes="{{ __('Yes') }}" data-text-no="{{ __('No') }}" >
                                                        <i class="ti ti-trash" data-bs-toggle="tooltip" title="{{ __('Delete') }}"></i>
                                                    </button>
                                ...
                                <div class="col-xxl-6 col-12">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pt-3" id="btn-pur">
                                        ...
                                        <div class="tab-content btn-empty text-end">
                                            ...
                                            <a href="#"
                                               class="btn btn-danger show_confirm rounded m-0" data-confirm="{{ __('Are You Sure?') }}"
                                               data-text="{{ __('This action can not be undone. Do you want to continue?') }}" data-text-yes="{{ __('Yes') }}" data-text-no="{{ __('No') }}" >{{ __('Empty Cart') }}
                                            </a>
