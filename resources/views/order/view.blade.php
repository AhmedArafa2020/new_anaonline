                        ...
                        <div class="row row-gap align-items-center justify-content-end">
                            <div class="col-xxl-2 col-lg-3 col-sm-4 col-12 px-2">
                                <div class="btn-group w-100" id="deliver_btn">
                                    <button
                                        class="btn-badge w-100  btn {{ $btn_class }} {{ in_array($order['order_status'], [0, 1, 4, 5, 6]) ? 'dropdown-toggle' : '' }} order_status_btn"
                                    ...
                                    @if (in_array($order['order_status'], [0, 1, 4, 5, 6, 7, 8]))
                                        <div class="dropdown-menu" data-popper-placement="bottom-start">
                                            <h5 class="dropdown-header" style="font-size: 14px;">{{ __('Set order status') }}</h5>
