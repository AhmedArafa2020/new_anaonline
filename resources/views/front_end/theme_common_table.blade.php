                                ...
                                <div class="row desc-row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="img-wrapper">
                                            <img src=" {{ get_file($product->cover_image_path ?? '', $currentTheme) }}" alt="desc-img">
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <section class="pro-info-sec">
                                <div class="row align-items-center">
                                    <div class="col-sm-6 col-12">
                                        <div class="img-wrapper">
                                            @php
                                                $firstImage = $product->Sub_image($product->id)['data'][0] ?? '';
                                            @endphp

                                           <img src="{{ get_file($firstImage['image_path'], $currentTheme) }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="left-side-content dark-p">
