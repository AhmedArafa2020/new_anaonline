<section class="best-product-section padding-bottom" style="position: relative;@if (isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-12">
                <div class="best-product-left-inner">
                        ...
                        <a href="{{ route('page.product-list', $slug) }}" class="btn" id="{{ ($section->best_product->section->button->slug ?? '') }}_preview"><svg
                                ...
                                <path
                                    ...
                                    fill="white" />
                            </svg>{!! $section->best_product->section->button->text ?? '' !!}</a>
                            ...
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <div class="product-content-top">
                                        ...
                                        <h5><a
                                                href="{{ url($slug.'/product/'. $data->slug) }}"><b>{{ $data->name }}</b></a>
                                        </h5>
                                    ...
                                    <div class="product-content-bottom">
                                        ...
                                        <div class="product-action-btn d-flex align-items-center justify-content-between">
                                            <a href="javascript:void(0)"
                                                ...
                                                product_id="{{ $data->id }}" variant_id="0" qty="1"><svg
