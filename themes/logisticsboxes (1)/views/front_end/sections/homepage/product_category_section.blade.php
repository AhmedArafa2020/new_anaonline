<section class="padding-top padding-bottom product-categories-section"style="@if (isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
                ...
                <div class="tab-nav">
                    ...
                    <ul class="tabs d-flex">
                        @foreach ($category_options as $cat_key => $category)
                            <li class="tab-link-btn {{ $cat_key == 0 ? 'active' : '' }}"
                                data-tab="{{ $cat_key }}"><a href="javascript:;"><svg
                                            ...
                                            <div class="product-content">
                                                <div class="product-content-top">
                                                    <div
                                                        ...
                                                        <div class="subtitle">{{ $data->ProductData->name }}</div>
                                                    ...
                                                    <h5><a href="{{ url($slug.'/product/'.$data->slug) }}"><b>{{ $data->name }}</b>
                                                        </a></h5>
