...
<body @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-page" @elseif (in_array(\Request::route()->getName(), ['page.product'])) class="product-page" @else class="" @endif>
