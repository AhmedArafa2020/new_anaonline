...
<!-- header start  -->
<header
    @if (\Request::route()->getName() == 'landing_page') class="site-header common-header header-style-one" @else
    class="site-header common-header" @endif
    ...
    <div class="header-top">
        <div class="container right-side-header">
            <div class="header-top-row">
                ...
                <div class="header-top-time" id="{{ $section->header->section->title->slug ?? '' }}_preview">
                    ...
                    <div class="bottom-header-right d-flex align-items-center">
                        <div class="header-bottom-call">
                            <span class="desk-only"
                                id="{{ $section->header->section->support_title->slug ?? '' }}_preview">
                                {!! $section->header->section->support_title->text ?? '#' !!}</span>
                            <a href="tel:{{ $section->header->section->support_value->text }}" target="_blank"
                                title="call">
                                <span class="desk-only"
                                    id="{{ $section->header->section->support_value->slug ?? '' }}_preview">
                                    {!! $section->header->section->support_value->text ?? '#' !!}</span>
                            </a>
                        </div>
                        <div class="bottom-header-cart cart-header">
                            <a href="javascript:;" title="cart" class="cart-header">
                                ...
                                <span class="desk-only cart-price"> {{ $currency ?? '' }}
