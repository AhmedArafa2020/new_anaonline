<section class="sixth-sec padding-bottom"
    ...
    <img src="{{ get_file($section->variant_background->section->image->image ?? '', $currentTheme)}}" id="{{ ($section->variant_background->section->image->slug ?? '').'_preview'}}" alt="banner-img" loading="lazy" class="sixth-sec-banner">
    <div class=" container">
            ...
            <div class=" d-flex justify-content-center align-items-center">
                <a href="javascript:void(0)" class=" variant-play-btn"
                    ...
                    <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <rect width="45" height="44" fill="url(#patternvariant0)"/>
                        <defs>
                        <pattern id="patternvariant0" patternContentUnits="objectBoundingBox" width="1" height="1">
