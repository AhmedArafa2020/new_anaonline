<section class="filter-sec padding-top padding-bottom"
    ...
    <img src="{{ asset('themes/' . $currentTheme . '/assets/images/d6.png') }}" class="d-left" style="top: 35%;">
    <img src="{{ asset('themes/' . $currentTheme . '/assets/images/right.png') }}" class="d-right" style="top: 0;">
    <div class=" container">
        <div class="title d-flex justify-content-between align-items-center flex-wrap">
            ...
            <ul class="category-buttons d-flex tabs">
                ...
                <li class="tab-link  {{ $cat_key == 0 ? 'active' : '' }}" data-tab="{{ $cat_key }}"><a
