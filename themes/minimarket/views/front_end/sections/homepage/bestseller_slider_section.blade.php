<section class="best-seller-sec padding-bottom padding-top"
    ...
    <img src="{{ asset('themes/' .$currentTheme . '/assets/images/d1.png') }}" class="d-right" style="top: 0;">
    <img src="{{ asset('themes/' .$currentTheme . '/assets/images/d2.png') }}" class="d-left" style="bottom: 0;">
    <img src="{{ asset('themes/' .$currentTheme . '/assets/images/left.png') }}" class="d-left" style="top: 0;">
    <div class=" container">
        <div class="seller-heading text-center">
            <h2 id="{{ ($section->bestseller_slider->section->title->slug ?? '') }}_preview">
                <a href="{{ route('page.product-list', $slug) }}">{!! $section->bestseller_slider->section->title->text
                    ?? ""!!}</b></a>
            </h2>
        </div>
