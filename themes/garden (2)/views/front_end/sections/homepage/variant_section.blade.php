<section class="sixth-sec mb-6"
    style="background-image: url({{ get_file($section->variant_background->section->image->image, $currentTheme) }});position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <div class=" container">
        <div class="common-heading">
            <span class="sub-heading" id="{{ $section->variant_background->section->sub_title->slug ?? '' }}_preview">
