    ...
    <div class="footer-top">
        <div class=" container">
            <div class="row main-footer">
                        ...
                        <div class=" col-md-6 col-12">
                            <div class="footer-col footer-description">
                                <div class="footer-time"
                                    id="{{ $section->header->section->title->slug ?? '' }}_preview">
                                    {!! $section->footer->section->title->text ?? '' !!}
                                </div>
                                <p> {!! $section->footer->section->description->text !!}</p>
                            </div>
                        </div>
                ...
                <div class=" col-lg-5 col-12 footer-right">
                    <div class=" row">
                        ...
                        <div class=" col-lg-5 col-md-6 col-12">
                            <div class="footer-icons social-media">
                                <h6 class="footer-title"
                                    id="{{ $section->header->section->sub_title->slug ?? '' }}_preview">
                                    {!! $section->footer->section->sub_title->text ?? '' !!}</h6>
            ...
            <div class="footer-copyright">
                ...
                <div class="footer-menu">
                    <ul class="footer-links">
                        ...
                        @endif
                        @endforeach
                        {{-- <li><a href="{{ $homepage_footer_section8_link }}" class="active">{!!
                        $homepage_footer_section_label !!}</a></li> --}}
                        {{-- @endfor --}}
                    </ul>
                </div>
            </div>
