...
<section class="second-sec padding-top padding-bottom" style="position: relative;@if (isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
...
<img src="{{ asset('themes/' . $currentTheme . '/assets/images/bakery-1.png') }}" class="bakery-1" alt="image">
    <div class=" container">
            ...
            <div class=" col-md-6  col-12">
                <div class="second-sec-right-side dark-p">
                    <div class="img-wrapper">
                        <img src="{{ get_file($section->product_category->section->image->image ?? 'themes/' . $currentTheme . '/assets/img/banner-sec-7.png', $currentTheme) }}"id="{{ $section->product_category->section->image->slug ?? '' }}_preview"
                            alt="chocolate">
                    </div>
                    <p id="{{ $section->product_category->section->description->slug ?? '' }}_preview">
                        {!! $section->product_category->section->description->text ?? '' !!}</p>
