...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ asset((isset($theme_favicon) && !empty($theme_favicon)) ? $theme_favicons : 'themes/' . $currentTheme . '/assets/images/Favicon.png') }}">
    ...
    <link rel="apple-touch-icon" href="{{ asset((isset($theme_favicon) && !empty($theme_favicon)) ? $theme_favicons : 'themes/' . $currentTheme . '/assets/images/Favicon.png') }}">
...
<body @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-page" @elseif(in_array(\Request::route()->getName(), ['page.product'])) class="product-page" @elseif(in_array(\Request::route()->getName(), ['page.contact_us'])) class="contact-page" @endif>
    <!-- [ Main Content ] start -->
    <div class="{{ \Request::route()->getName() == ['landing_page'] ? '' : 'about-wrapper' }}">
