<div class="home">
    <img src="{{ asset('themes/' . $currentTheme . '/assets/images/left-leaf.png') }}" alt="leaf" id="left-side-img">
    <img src="{{ asset('themes/' . $currentTheme . '/assets/images/right-leaf.png') }}" alt="leaf" id="right-side-img">
    <div class="main-top padding-top">
        <img src="{{ asset('themes/' . $currentTheme . '/assets/images/leaf-design.png') }}" id="leaf-design"
            alt="leaf-design">
        <img src="{{ asset('themes/' . $currentTheme . '/assets/images/circle-design.png') }}" id="circle-design1"
            alt="circle-design">
        <!-- hero section start  -->
        <section class="hero-sec"
            ...
            <div class=" container">
                <div class="hero-main-slider">
                    @for ($i = 0; $i < $section->slider->loop_number; $i++)
                        <div class="hero-slides common-heading">
                            <span class="sub-heading"
                                id="{{ ($section->slider->section->title->slug ?? '') . '_' . $i }}_preview">
                                {!! $section->slider->section->title->text->{$i} ?? '' !!} </span>
                            <h2 class="h1"
                            ...
                            <div class="hero-btn">
                                <a href="{{ route('page.product-list', $slug) }}" class="common-btn">
                                    <span
                                        id="{{ ($section->slider->section->button_first->slug ?? '') . '_' . $i }}_preview">{!! $section->slider->section->button_first->text->{$i} ?? '' !!}</span>
