...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400;500;600;700;800;900&amp;family=Quicksand:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet">
    ...
    <link rel="apple-touch-icon" href="{{ get_file((isset($theme_favicon) && !empty($theme_favicon)) ? $theme_favicon : 'themes/' . $currentTheme . '/assets/images/Favicon.png', $currentTheme) }}">    @if ($store->enable_pwa_store == 'on')
...
<body @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-page"   @endif>
