<section class="blog-section padding-bottom"    style="position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <div class="container">
        <div class="section-title d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('page.blog',$slug) }}" class="btn" tabindex="0"  id="{{ $section->blog->section->button->slug ?? '' }}_preview">
