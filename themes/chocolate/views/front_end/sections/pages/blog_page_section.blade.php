            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="common-banner-content">
                        ...
                        <a href="{{ route('landing_page',$slug) }}" class="btn-secondary white-btn" tabindex="0">
    ...
    <section class="blog-grid-section tabs-wrapper padding-bottom padding-top">
        <div class="container">
            <div class="d-flex blog-grid-title justify-content-between align-items-center ">
                <div class="section-title">
                    <span
                        class="sub-title">{{ $page_json->blog_page->section->section_title->text ?? __('All Products') }}</span>
                    <h2>{!! $page_json->blog_page->section->section_sub_title->text ?? __('From our blog') !!}</h2>
                </div>
                <a href="{{ route('landing_page', $slug) }}" class="btn">{{ $page_json->blog_page->section->section_sub_button->text ?? __('Read More') }}</a>
            </div>
