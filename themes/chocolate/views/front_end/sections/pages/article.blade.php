                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="common-banner-content">
                            ...
                            <a href="{{ route('page.blog', $slug) }} " class="btn-secondary" tabindex="0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="articlerightbar">
                            <div class="section-title">
                                <h2>{{ $page_json->article_page->section->related_title->text ?? __('Related articles') }}
                                </h2>
                            </div>
                                        ...
                                        <div class="blog-card">
                                            <div class="blog-card-inner">
                                                ...
                                                <div class="blog-card-content">
                                                    ...
                                                    <div class="section-title">
                                                        <h3>
                                                            <a href="{{ route('page.article', [$slug, $data->id]) }}">{{ $data->title }}
                                                            </a>
                                                        </h3>
                                                    </div>
                                                    <p class="description">
