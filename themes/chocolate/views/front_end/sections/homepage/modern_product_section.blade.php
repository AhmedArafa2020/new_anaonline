    ...
    <div class="container">
        <div class="video-content">
            <div class="section-title">
                <span class="sub-title" id="{{ $section->modern_product->section->sub_title->slug ?? '' }}_preview">
            ...
            <p id="{{ $section->modern_product->section->description->slug ?? '' }}_preview">
                ...
                <div class="btn-wrapper justify-content-center">
                    <a href="javascript:void()" class="variant-play-btn"
    ...
    <div class="popup-inner">
        <div class="content">
            ...
            <iframe width="560" height="315"
                src="@if ($section->modern_product->section->video->type == 'text') {{ $section->modern_product->section->video->text }}
                            @else
                                {{ get_file($section->modern_product->section->video->text, $currentTheme) }} @endif"
