<section class="home-blog-section padding-top"  style="position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <div class="custome_tool_bar"></div>
        <img src="{{asset('themes/'.$currentTheme.'/assets/images/blog-ring-1.png')}}" class="blog-ring" alt="image">
        <img src="{{asset('themes/'.$currentTheme.'/assets/images/full-bluthooth.png')}}" class="blog-blutooth" alt="image">
        <div class="container">
                <div class="section-title d-flex justify-content-between align-items-center">
                    ...
                    <div class="section-title-right">
                        <a href="{{route('page.product-list',$slug)}}" class="btn-primary btn-transparent"  id="{{ $section->blog->section->button->slug ?? '' }}_preview"> {!!
