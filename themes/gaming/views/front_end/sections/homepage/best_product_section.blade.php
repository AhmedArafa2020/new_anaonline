<section class="home-product-extra padding-top" style="position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <div class="custome_tool_bar"></div>
        ...
        <div class="section-title d-flex justify-content-between align-items-center">
            ...
            <div class="section-title-right">
                <a href="{{route('page.product-list',$slug)}}" class="btn-primary btn-transparent" id="{{ $section->best_product->section->button->slug ?? '' }}_preview"> {!!
