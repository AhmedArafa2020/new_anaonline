<section class="related-product-section padding-bottom"
    ...
    <div class="container">
        <div class="section-title d-flex align-items-center justify-content-between">
            ...
            <a href="{{route('page.product-list',$slug)}}" class="btn"><svg xmlns="http://www.w3.org/2000/svg"
                    width="16" height="10" viewBox="0 0 16 10" fill="none"
                    id="{{ ($section->best_product_second->section->button->slug ?? '') }}_preview">                    
                    <path
                        ...
                        fill="white"></path>
                </svg>{!! $section->best_product_second->section->button->text ?? '' !!}
            </a>
        </div>
                    ...
                    <div class="product-content">
                        <div class="product-content-top">
                            <div class="top-subtitle d-flex align-items-center justify-content-between">
                                <p><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13"
                                        fill="none">
                                        <path
                            ...
                            <h5><a href="{{ url($slug.'/product/'. $data->slug) }}"><b>{{ $data->name }}</b></a>
                            </h5>
