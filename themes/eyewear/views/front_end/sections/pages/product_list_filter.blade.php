            ...
            <div class="product-card-inner">
                <div class="product-content-top text-center">
                    ...
                    <div class="favorite-icon">
                        <a href="javascript:void(0)" class="wishbtn-globaly" product_id="{{ $product->id }}"
                ...
                <div class="product-content-bottom text-center">
                    <div class="price-label2">
                        @if ($product->variant_product == 0)
                            <div class="price">
                                <ins>{!! currency_format_with_sym(
                                    \App\Models\Product::ProductPrice($currentTheme, $slug, $product->id, $product->variant_id),
                                    $store->id,
                                    $currentTheme,
                                ) !!}</ins>
                            </div>
