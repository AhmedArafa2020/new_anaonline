...
@section('content')
    ...
    @foreach ($blogs as $blog)
        <section class="blog-page-banner common-banner-section" style="background-image:url({{ get_file( $page_json->article_page->section->image->image ?? 'themes/' . $currentTheme . '/assets/images/blog-banner.jpg', $currentTheme)}});">
            <div class="container">
                <div class="row">
                            ...
                            @foreach ($datas as $blog)
                                <div class="blog-card-itm-inner">
                                    ...
                                    <div class="blog-card-content">
                                        ...
                                        <h4>
                                            <a href="{{route('page.article',[$slug,$blog->id])}}" tabindex="0" class="description">{{$blog->title}}
                                            </a>
                                        </h4>
                                        <p class="description">{{$blog->short_description}}</p>
