                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 col-12">
                            <div class="left-review-wrapper">
                                ...
                                <p id="{{ ($section->newest_category->section->description->slug ?? '') }}_preview">{!! $section->newest_category->section->description->text ?? "" !!}</p>
                                <div class="reiview-slider flex-slider">
                                    @foreach ($reviews as $review)
                                        <div class="review-itm">
                                            <div class="review-inner">
                                                <div class="review-img">
                                                    <img src="{{ get_file($review->ProductData->cover_image_path ?? '', $currentTheme) }}" alt="">
                                                </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="right-review-wrapper">
                                <img src="{{ get_file($section->newest_category->section->background_image->image ?? '', $currentTheme) }}" alt="">
                            </div>
                        </div>
                    </div>
            </div>
