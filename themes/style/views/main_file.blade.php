    ...
    @section('content')
        @if(isset($theme_section) && count($theme_section) > 0)
            @foreach($theme_section as $option)
                ...
                @elseif ($option->section_name == 'top_product')
                        @include('front_end.sections.homepage.top_product_section')
                ...
                @elseif ($option->section_name == 'service_section')
                        @include('front_end.sections.homepage.service_section')
