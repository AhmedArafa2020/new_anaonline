                        ...
                        <div class="product-card-inner">
                            <div class="product-card-image">
                                <a href="{{url($slug.'/product/'.$latest_product->slug)}}">
                                    ...
                                    <img src="{{ get_file($latest_product->Sub_image($latest_product->id)['data'][0]->image_path, $currentTheme) }}"
                                        class="hover-img">
                                    @else
                                    <img src="{{ get_file($latest_product->Sub_image($latest_product->id), $currentTheme) }}"
                                        class="hover-img">
                                    @endif
                                </a>
                            </div>
                            <div class="product-content">
                                <div class="product-content-top">
                                    ...
                                    <div class="product-type">{{ $latest_product->ProductData->name }} /
                                        {{ $latest_product->SubCategoryctData->name }}</div>
