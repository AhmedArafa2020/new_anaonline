<header class="site-header header-style-one"  style="@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
            ...
            <div class="announce-row row align-items-center">
                <div class="annoucebar-left col-6 d-flex">
                    <p id="{{ $section->header->section->title->slug ?? '' }}_preview">
                        <img src="{{asset('themes/' . $currentTheme . '/assets/images/arrow.png')}}" alt="" class="contact">
                        {!!$section->header->section->title->text ?? '' !!}
                    </p>
                </div>
                <div class="announcebar-right col-6 d-flex justify-content-end">
                    <a href="tel:610403403"id="{{ $section->header->section->button->slug ?? '' }}_preview">
                        <span>{!!$section->header->section->button->text ?? '' !!}</span>
                        <img src="{{asset('themes/' . $currentTheme . '/assets/images/call.png')}}" alt="" class="contact_us">
                    </a>
