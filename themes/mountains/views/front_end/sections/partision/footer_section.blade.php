...
<footer class="site-footer" style="@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <img src="{{ get_file($section->footer->section->background_image->image ?? '')}}" class="footer-bg"
                ...
                <div class="footer-widget">
                    ...
                    <form class="footer-subscribe-form" action="{{ route('newsletter.store',$slug) }}" method="post">
                        ...
                        <div class="checkbox-custom">
                            ...
                            <label for="subsection" id="{{ $section->footer->section->newsletter_description->slug ?? '' }}_preview">{!! $section->footer->section->newsletter_description->text ?? '' !!}</label>
                        </div>
                    </form>
                </div>
            </div>
