...
@else
    <header class="site-header site-header-product-page header-style-one  style="@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif" data-index="{{ $option->order ?? '' }}" data-id="{{ $option->order ?? '' }}" data-value="{{ $option->id ?? '' }}" data-hide="{{ $option->is_hide  ?? '' }}" data-section="{{ $option->section_name  ?? '' }}"  data-store="{{ $option->store_id  ?? '' }}" data-theme="{{ $option->theme_id ?? '' }}">
    <div class="custome_tool_bar"></div>
@endif
                            ...
                            <ul class="d-flex align-items-center justify-content-end">
                                ...
                                <li class="header-user">
                                    <a href="{{ route('customer.login',$slug) }}">
                                        ...
                                        <span class="header-desk-only icon-lable" style="color: #000; margin-right: 9px;">{{ __('Login') }}</span>
                                    </a>
                                </li>
                                @endguest
                                @auth('customers')
                                ...
                                @auth('customers')
                                    <li class="header-wishlist">
                                        ...
                                        <span class="count"> {!! \App\Models\Wishlist::WishCount($slug) !!}</span>
                                    </li>
                                @endauth
    ...
    <div class="main-navigationbar">
        <div class="container">
            <div class="navigationbar-row d-flex align-items-center">
                <div class="menu-items-col row align-items-center no-gutters">
                    <div class="col-lg-10 col-md-6 col-sm-4 col-4 d-flex align-items-center justify-content-between main-nav-bg">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-8 col-8">
                        ...
                        <div class="header-mobile-only">
                            <ul class="menu-right d-flex">
                                ...
                                <li class="cart-header">
                                    <a href="javascript:;">
                                        {{-- <span class="price">{{ __('Cart:') }} {!! \App\Models\Cart::CartCount($slug) !!} </span> --}}
                                        <span class="count">{!! \App\Models\Cart::CartCount($slug) !!}</span>
