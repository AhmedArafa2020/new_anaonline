        ...
        <div class="container">
            <div class="common-banner-content">
                <a href="{{ route('page.product-list', $slug) }}" class="back-btn">
                    ...
                    {!! $page_json->product_page->section->button->text ?? __('Back to Categories') !!}
                </a>
            </div>
            <div class="row align-items-center col-reverse no-gutters product-info">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="pdp-cart-btn-wrp">
                        ...
                        @if ($product->track_stock == 0 && $product->stock_status == 'out_of_stock')
                        @else
                            <a href="javascript:void(0)" class="btn btn-secondary addtocart-btn btn addcart-btn  addcart-btn-globaly price-wise-btn product_var_option"
