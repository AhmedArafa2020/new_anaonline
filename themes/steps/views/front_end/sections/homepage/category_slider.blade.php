@foreach ($best_seller_category as $key => $category)
        ...
        <div class="meet-cat-box-inner">
            ...
            <div class="cat-content">
                ...
                <a href="{{ route('page.product-list', [$slug,'main_category' => $category->id]) }}" class="add-cart-btn">
                    ...
                    @php
                    $landing_categories_products_count = App\Models\Product::where('maincategory_id', $category->id)->where('theme_id', $themeId)->count();
                    @endphp
