    ...
    <div class="our-blog-itm">
        <div class="our-blog-itm-inner">
            <div class="our-blog-img">
                <a href="{{route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])}}" class="blog-img">
                    <img src=" {{ get_file($blog->cover_image_path, $currentTheme) }}">
                </a>
                <a href="{{route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])}}" class="btn article-btn">Article</a>
            </div>
            <div class="our-blog-content">
                <div class="our-blog-content-top">
                    ...
                    <h3><a href="{{route('page.article',['storeSlug'=>$slug, 'id'=>$blog->id])}}" class="name">{{ $blog->title }}</b></a>
                    </h3>
                ...
                <div class="our-blog-content-bottom">
                    <div class="our-blog-contnt-btm-row d-flex align-items-center justify-content-between">
                        <h4>{{ $blog->store->user->name ?? 'John Doe' }}</h4>
