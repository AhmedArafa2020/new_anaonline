    ...
    <div class="offset-container offset-left">
            ...
            <div class="col-md-4 col-12 d-flex align-items-center">
                <div class="two-coll-content">
                    ...
                    <div class="common-block">
                        ...
                        <div class="lable-btn btn" id="{{
                $section->best_product->section->button->slug ?? '' }}_preview">{!!
                $section->best_product->section->button->text ?? '' !!}</div>
                        <div class="thmb-pro-main">

                            <div class="thumb-pro-main-itm">
                                <a href="{{ url($slug.'/product/'.$landing_product->slug) }}">
                                    <img src="{{ get_file($landing_product->cover_image_path, $currentTheme) }}">
                                </a>
                            </div>
                            @if ($landing_product->Sub_image($landing_product->id)['status'] == true)
                                ...
                                <div class="thumb-pro-main-itm">
                                    <img src=" {{ get_file($value->image_path, $currentTheme) }}" class="hover-img">
                                </div>
                                @endforeach
                            @endif
                        </div>
                        <div class="section-title">
                            <h2><a href="{{ url($slug.'/product/'.$landing_product->slug) }}"
                                    class="name">{{ $landing_product->name }}
                                </a>
                            </h2>
                            {!! \App\Models\Product::actionLinks($currentTheme, $slug, $landing_product) !!}
                            ...
                            <div class="thumb-pro-inner">
                                ...
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18"
                                        fill="none">
                                        <circle r="8.61532" transform="matrix(-1 0 0 1 9.51847 9.18661)" fill="white" />
                    ...
                    <div class="d-flex price-wrap-flex align-items-end justify-content-between">
                        ...
                        <a href="javascript:void(0)" class="add-cart-btn  addcart-btn-globaly"
                            product_id="{{ $landing_product->id }}" variant_id="0" qty="1">
        ...
        <div class="col-md-8 col-12 d-flex">
            <div class="two-coll-media">
                <img src="{{ get_file($section->best_product->section->image->image ?? '', $currentTheme) }}" id="{{ $section->best_product->section->image->slug ?? ''}}_preview">
