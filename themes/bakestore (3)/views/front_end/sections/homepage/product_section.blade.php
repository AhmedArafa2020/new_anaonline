<div class="main-center">
        <section class="product-slider-sec"  style="position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
                        ...
                        <div class="product-card-inner card-inner">
                            ...
                            <div class="card-bottom">
                                <div class="card-title">
                                    <h3>
                                        <a href="{{ url($slug.'/product/'.$product->slug) }}" class="names">
                                            {{ $product->name }}
                                        </a>
                                    </h3>
                                </div>
