                    ...
                    <div class="col-lg-6 col-12">
                        <div class="common-banner-content">
                            ...
                            <div class="section-title">
                                <h2>
                                    {{$page_json->collection_page->section->title->text ?? __('Shopping Category')}} <span>({{ $product_count ?? 0 }})</span></h2>
                            </div>
                            <p>{{ $page_json->collection_page->section->description->text ?? __('Welcome to our delectable collection of food-related products. Explore a world of culinary delights, from gourmet ingredients to kitchen essentials, all carefully curated to elevate your gastronomic experience.')}}</p>
                        </div>
                    </div>
                </div>
            </div>
