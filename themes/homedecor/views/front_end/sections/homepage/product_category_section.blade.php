            ...
            @foreach ($MainCategoryList->take(2) as $key => $MainCategory)
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="interiors-design-wrapper">
                        <img src="{{ get_file($MainCategory->image_path, $currentTheme)}}" class="design-bg-img">
                                ...
                                <div class="columnl-left-media-inner">
                                    <div class="column-left-media-content">
                                        ...
                                        <a href="{{ route('page.product-list', [$slug, 'main_category' => $MainCategory->slug]) }}"
                                            ...
                                            {!! $section->product_category->section->button_second->text ?? 'Show More' !!}
                            ...
                            @foreach ($prod as $pro)
                                @if ($pro->maincategory_id == $MainCategory->id)
                                    <div class="col-lg-7 col-12">
                                        <div class="columnl-right-caption-inner product-card">
                                            <div class="product-card-inner">
                                                <div class="product-card-image">
                                                    <a href="{{ url($slug.'/product/'.$pro->slug) }}"
                                                        class="product-img">
                                                        <img src="{{ get_file($pro->cover_image_path ?? '', $currentTheme) }}"
                                                    ...
                                                    {!! \App\Models\Product::actionLinks($currentTheme, $slug, $pro) !!}
                                                </div>
                                                <div class="product-content">
                                                    ...
                                                    <div class="show-more-btn">
                                                        ...
                                                        {!! \App\Models\Product::ProductcardButton($currentTheme, $slug, $pro) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
