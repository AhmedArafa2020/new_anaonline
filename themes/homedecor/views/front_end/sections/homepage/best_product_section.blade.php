                ...
                <div class="best-pro-item product-card">
                    <div class="product-card-inner ">
                        <div class="product-card-image">
                            <a href="{{ url($slug.'/product/'.$all_product->slug) }}" class="product-img">
                                <img src="{{ get_file($all_product->cover_image_path ?? '', $currentTheme) }}" alt="bestproduct">
                                <div class="new-labl">
                            ...
                            <div class="product-content">
                                ...
                                <div class="show-more-btn">
                                    <a href="{{ route('page.product-list', $slug) }}" class="link-btn" tabindex="0">
                                        {!! $section->best_product->section->button->text ?? 'Show More' !!}
